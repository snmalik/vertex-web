...
import styles from "../../style/Navbar.module.css"; // Import Module CSS
        ...
        <div className={styles.navContainer}>
          ...
          <ul className={`${styles.navMenu} ${isMobileMenuOpen ? styles.active : ""}`}>
            {menuItems.map((item, index) => {
              // Special handling for "Services" item logic if needed, 
              // but here we follow the existing structure where Services is a specific list item with a mega menu
